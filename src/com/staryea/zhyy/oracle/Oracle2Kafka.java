package com.staryea.zhyy.oracle;
...
public class Oracle2Kafka {
	private static final Logger log = LoggerFactory.getLogger(Oracle2Kafka.class);
...
//		String log_conf = System.getProperty("user.dir") + "/config/oracle/log4j.properties";
		String log_conf = args[0];
		PropertyConfigurator.configure(log_conf);

//		String jdbc_conf = System.getProperty("user.dir") + "/config/oracle/conf.properties";
